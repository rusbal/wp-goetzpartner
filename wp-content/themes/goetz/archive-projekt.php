            ...
            <div class="wf-container-main">
                <div id="content" class="content" role="main">
                    ...
                    <div class="wf-container loading-effect-fade-in iso-container bg-under-post description-under-image content-align-left" data-padding="10px" data-cur-page="1" data-width="320px" data-columns="3">
                        <?= View::projectsArchive() ?>
                    </div>

<!--                    <div class="paginator" role="navigation">-->
<!--                        <div class="page-links"><a href="https://www.fachwerk4.de/projekt/" class="act" data-page-num="1">1</a><a href="https://www.fachwerk4.de/projekt/page/2/"  data-page-num="2">2</a></div>-->
<!--                        <div class="page-nav"><a href="https://www.fachwerk4.de/projekt/page/2/" class="nav-next" data-page-num="2">Next page</a></div>-->
<!--                    </div>-->
...
<script type='text/javascript'>
//    _stq = window._stq || [];
//    _stq.push([ 'view', {v:'ext',j:'1:4.3.2',blog:'103843918',post:'0',tz:'1',srv:'www.fachwerk4.de'} ]);
//    _stq.push([ 'clickTrackerInit', '103843918', '0' ]);
</script>
</body>